    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $instagram = $user['instagram'];
         ...
         if (!empty($user['foto_profil'])) {
          ...
          // Ambil data gambar konten yang disimpan dan diunggah oleh pengguna
          ...
          // Ambil data gambar konten yang disimpan dan diunggah oleh pengguna
          $query = "SELECT k.nama_gambar
          FROM simpan s
          JOIN konten k ON s.id_konten = k.id_konten
  ...
  <div class="header__wrapper">
      <div class="cols__container">
        ...
        <div class="button">
          <nav>
            <ul>
              <label onclick="window.location.href='profilUpload.php'">Diunggah</label>
              <label></label>
              <label class="disimpan" onclick="window.location.href='profilSave.php'">Disimpan</label>
            </ul>
          </nav>          
